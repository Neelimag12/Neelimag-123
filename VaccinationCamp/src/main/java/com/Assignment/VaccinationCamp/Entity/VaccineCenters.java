package com.Assignment.VaccinationCamp.Entity;
...
public class VaccineCenters {
	...
	public VaccineCenters(Long id, String centerName, int centerPincode, String district, Long availablevaccine) {
		super();
		this.id = id;
	...
	public VaccineCenters(String centerName, int centerPincode, String district, Long availablevaccine) {
		super();
		this.centerName = centerName;
		this.centerPincode = centerPincode;
		this.district = district;
